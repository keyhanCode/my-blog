...
<figure>
  <Image alt="The first website ever" src="/content/jamstack/first-website-ever.jpg" width={800} height={400} />
  <figcaption>The first website ever</figcaption>
</figure>
...
<div className="my-22 flex w-full flex-col font-extrabold">
  <div className="flex flex-1 flex-row p-0">
    <div className="flex-1 border-2 border-transparent bg-yellow-600 px-12 py-4 text-center text-gray-800">
      JavaScript
    </div>
    <div className="flex-1 border-2 border-transparent bg-red-500 px-12 py-4 text-center text-gray-800">API</div>
    <div className="flex-1 border-2 border-transparent bg-fuchsia-400 px-12 py-4 text-center text-gray-800">Markup</div>
  </div>
  <div className="flex-1 border-2 border-transparent bg-yellow-500 px-12 py-4 text-center text-gray-800">JAM</div>
</div>
...
Ping me on [Twitter](https://twitter.com/thedevdavid) and I'm happy to help.
